    ...
    <div style={{ minHeight: '100vh', background: '#FAFAFA', fontFamily: "'DM Sans', sans-serif" }}>
      ...
      <div style={{ maxWidth: 800, margin: '0 auto', padding: '40px 24px' }}>
        ...
        {[
          ...
          { titre: "5. Abonnement et paiement", contenu: "L'abonnement mensuel est facturé 500 000 FCFA TTC par mois, donnant droit à 3 études complètes par mois. Le paiement est effectué en début de période via les moyens de paiement disponibles (Wave, Orange Money, Free Money, carte bancaire). L'abonnement est sans engagement et peut être résilié à tout moment. Aucun remboursement n'est effectué pour les études déjà générées." },
